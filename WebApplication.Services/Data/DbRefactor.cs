...
{
    public static class DbRefactor
    {
        public static MyContext GetManufacturers()
        {
            ...
            foreach (var item in manufacturerData) {
                ...
                List<VehicleModel> vehiclelModelTempList = new List<VehicleModel>();
                ...
                foreach (var item2 in vehiclemodelData)
                {
                    if (item2.ManufacturerId == item.Id)
                    {
                        ...
                        vehiclelModelTempList.Add(vehicleModel);
                    }
                }

                manufacturerRefactor.vehicleModel = vehiclelModelTempList;
